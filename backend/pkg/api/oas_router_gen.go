						...
						case 'p': // Prefix: "postgres"
							...
							case '/': // Prefix: "/"
								...
								case '/': // Prefix: "/"
									...
									switch elem[0] {
									case 'i': // Prefix: "introspect/tables"
										origElem := elem
										if l := len("introspect/tables"); len(elem) >= l && elem[0:l] == "introspect/tables" {
											elem = elem[l:]
										} else {
											break
										}
										...
										if len(elem) == 0 {
											switch r.Method {
											case "GET":
												s.handleStoragePostgresIntrospectTablesRequest([1]string{
													args[0],
												}, elemIsEscaped, w, r)
											default:
												s.notAllowed(w, r, "GET")
										...
										case '/': // Prefix: "/"
											...
											if len(elem) == 0 {
												...
												switch r.Method {
												case "GET":
													s.handleStoragePostgresIntrospectTableRequest([2]string{
														args[0],
														args[1],
													}, elemIsEscaped, w, r)
												default:
										...
										case 'a': // Prefix: "ables"
											...
											case '/': // Prefix: "/create"
												...
												if len(elem) == 0 {
													...
													switch r.Method {
													case "POST":
														s.handleStoragePostgresTablesCreateRequest([1]string{
															args[0],
														}, elemIsEscaped, w, r)
													default:
														s.notAllowed(w, r, "POST")
					...
					case '/': // Prefix: "/"
						...
						case 'c': // Prefix: "check"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "GET":
									s.handleCheckWorkspaceExistsRequest([0]string{}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, "GET")
								}
								...
								case '/': // Prefix: "/"
									...
									case 'i': // Prefix: "introspect/tables"
										...
										if len(elem) == 0 {
											switch method {
											case "GET":
												r.name = StoragePostgresIntrospectTablesOperation
												r.summary = ""
												r.operationID = "storage-postgres-introspect-tables"
												r.pathPattern = "/storage/postgres/{uuid}/introspect/tables"
												r.args = args
												r.count = 1
												return r, true
											default:
										...
										case '/': // Prefix: "/"
											...
											if len(elem) == 0 {
												...
												switch method {
												case "GET":
													r.name = StoragePostgresIntrospectTableOperation
													r.summary = ""
													r.operationID = "storage-postgres-introspect-table"
													r.pathPattern = "/storage/postgres/{uuid}/introspect/tables/{table_name}"
													r.args = args
													r.count = 2
													return r, true
												default:
										...
										case 'a': // Prefix: "ables"
											...
											case '/': // Prefix: "/create"
												...
												if len(elem) == 0 {
													...
													switch method {
													case "POST":
														r.name = StoragePostgresTablesCreateOperation
														r.summary = ""
														r.operationID = "storage-postgres-tables-create"
														r.pathPattern = "/storage/postgres/{uuid}/tables/create"
														r.args = args
														r.count = 1
														return r, true
													default:
				...
				case 's': // Prefix: "space"
					...
					if len(elem) == 0 {
						...
						case "POST":
							...
							r.summary = "Create a new workspace"
