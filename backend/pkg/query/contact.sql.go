...
const deleteContactByWorkspace = `-- name: DeleteContactByWorkspace :exec
DELETE FROM contact
WHERE uuid = $1
  AND workspace_uuid = $2
`

type DeleteContactByWorkspaceParams struct {
	UUID          uuid.UUID  `json:"uuid"`
	WorkspaceUUID *uuid.UUID `json:"workspace_uuid"`
}

func (q *Queries) DeleteContactByWorkspace(ctx context.Context, arg DeleteContactByWorkspaceParams) error {
	_, err := q.db.Exec(ctx, deleteContactByWorkspace, arg.UUID, arg.WorkspaceUUID)
	return err
}

const getContact = `-- name: GetContact :one
SELECT
    uuid, workspace_uuid, user_uuid, instance_uuid, status, names, names_search, last, first, middle, birthday, birthday_type, salary, salary_data, last_positions, last_position_id, last_position_company_id, last_position_company_name, last_position_title, last_position_start_date, last_position_end_date, last_position_end_now, last_position_description, note_search, note_kpi_id, phones, phone_search, phone1, phone1_type, phone1_country, phone2, phone2_type, phone2_country, phone3, phone3_type, phone3_country, phone4, phone4_type, phone4_country, phone5, phone5_type, phone5_country, emails, email_search, email1, email1_type, email2, email2_type, email3, email3_type, email4, email4_type, email5, email5_type, messengers, messengers_search, skype_uuid, skype, whatsapp_uuid, whatsapp, telegram_uuid, telegram, wechat_uuid, wechat, line_uuid, line, socials, socials_search, linkedin_uuid, linkedin_url, facebook_uuid, facebook_url, twitter_uuid, twitter_url, github_uuid, github_url, vk_uuid, vk_url, odno_uuid, odno_url, hhru_uuid, hhru_url, habr_uuid, habr_url, moikrug_uuid, moikrug_url, instagram_uuid, instagram_url, social1_uuid, social1_url, social1_type, social2_uuid, social2_url, social2_type, social3_uuid, social3_url, social3_type, social4_uuid, social4_url, social4_type, social5_uuid, social5_url, social5_type, social6_uuid, social6_url, social6_type, social7_uuid, social7_url, social7_type, social8_uuid, social8_url, social8_type, social9_uuid, social9_url, social9_type, tracking_source, tracking_slug, cached_img, cached_img_data, crawl, duplicate_user_id, duplicate_alternative_id, duplicate_report_date, entry_date, edit_date, last_kpi_entry_date
FROM contact
WHERE
    uuid = $1
LIMIT 1
...
const getContactByWorkspace = `-- name: GetContactByWorkspace :one
SELECT
    uuid, workspace_uuid, user_uuid, instance_uuid, status, names, names_search, last, first, middle, birthday, birthday_type, salary, salary_data, last_positions, last_position_id, last_position_company_id, last_position_company_name, last_position_title, last_position_start_date, last_position_end_date, last_position_end_now, last_position_description, note_search, note_kpi_id, phones, phone_search, phone1, phone1_type, phone1_country, phone2, phone2_type, phone2_country, phone3, phone3_type, phone3_country, phone4, phone4_type, phone4_country, phone5, phone5_type, phone5_country, emails, email_search, email1, email1_type, email2, email2_type, email3, email3_type, email4, email4_type, email5, email5_type, messengers, messengers_search, skype_uuid, skype, whatsapp_uuid, whatsapp, telegram_uuid, telegram, wechat_uuid, wechat, line_uuid, line, socials, socials_search, linkedin_uuid, linkedin_url, facebook_uuid, facebook_url, twitter_uuid, twitter_url, github_uuid, github_url, vk_uuid, vk_url, odno_uuid, odno_url, hhru_uuid, hhru_url, habr_uuid, habr_url, moikrug_uuid, moikrug_url, instagram_uuid, instagram_url, social1_uuid, social1_url, social1_type, social2_uuid, social2_url, social2_type, social3_uuid, social3_url, social3_type, social4_uuid, social4_url, social4_type, social5_uuid, social5_url, social5_type, social6_uuid, social6_url, social6_type, social7_uuid, social7_url, social7_type, social8_uuid, social8_url, social8_type, social9_uuid, social9_url, social9_type, tracking_source, tracking_slug, cached_img, cached_img_data, crawl, duplicate_user_id, duplicate_alternative_id, duplicate_report_date, entry_date, edit_date, last_kpi_entry_date
FROM contact
WHERE
...
type GetContactByWorkspaceParams struct {
	UUID          uuid.UUID  `json:"uuid"`
	WorkspaceUUID *uuid.UUID `json:"workspace_uuid"`
}

func (q *Queries) GetContactByWorkspace(ctx context.Context, arg GetContactByWorkspaceParams) (Contact, error) {
	row := q.db.QueryRow(ctx, getContactByWorkspace, arg.UUID, arg.WorkspaceUUID)
	var i Contact
	err := row.Scan(
		&i.UUID,
		&i.WorkspaceUUID,
...
ORDER BY entry_date DESC
LIMIT CASE WHEN $3::int = 0 THEN NULL ELSE $3::int END
    OFFSET $2::int
`
...
func (q *Queries) ListContactsByWorkspace(ctx context.Context, arg ListContactsByWorkspaceParams) ([]Contact, error) {
	rows, err := q.db.Query(ctx, listContactsByWorkspace, arg.WorkspaceUUID, arg.OffsetRecords, arg.LimitRecords)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
SET
    ...
    telegram_uuid             = COALESCE($59, telegram_uuid),
    telegram                  = COALESCE($60, telegram),
    wechat_uuid               = COALESCE($61, wechat_uuid),
    wechat                    = COALESCE($62, wechat),
    line_uuid                 = COALESCE($63, line_uuid),
    line                      = COALESCE($64, line),
    socials                   = COALESCE($65, socials),
    socials_search            = COALESCE($66, socials_search),
    linkedin_uuid             = COALESCE($67, linkedin_uuid),
    linkedin_url              = COALESCE($68, linkedin_url),
    facebook_uuid             = COALESCE($69, facebook_uuid),
    facebook_url              = COALESCE($70, facebook_url),
    twitter_uuid              = COALESCE($71, twitter_uuid),
    twitter_url               = COALESCE($72, twitter_url),
    github_uuid               = COALESCE($73, github_uuid),
    github_url                = COALESCE($74, github_url),
    vk_uuid                   = COALESCE($75, vk_uuid),
    vk_url                    = COALESCE($76, vk_url),
    odno_uuid                 = COALESCE($77, odno_uuid),
    odno_url                  = COALESCE($78, odno_url),
    hhru_uuid                 = COALESCE($79, hhru_uuid),
    hhru_url                  = COALESCE($80, hhru_url),
    habr_uuid                 = COALESCE($81, habr_uuid),
    habr_url                  = COALESCE($82, habr_url),
    moikrug_uuid              = COALESCE($83, moikrug_uuid),
    moikrug_url               = COALESCE($84, moikrug_url),
    instagram_uuid            = COALESCE($85, instagram_uuid),
    instagram_url             = COALESCE($86, instagram_url),
    social1_uuid              = COALESCE($87, social1_uuid),
    social1_url               = COALESCE($88, social1_url),
    social1_type              = COALESCE($89, social1_type),
    social2_uuid              = COALESCE($90, social2_uuid),
    social2_url               = COALESCE($91, social2_url),
    social2_type              = COALESCE($92, social2_type),
    social3_uuid              = COALESCE($93, social3_uuid),
    social3_url               = COALESCE($94, social3_url),
    social3_type              = COALESCE($95, social3_type),
    social4_uuid              = COALESCE($96, social4_uuid),
    social4_url               = COALESCE($97, social4_url),
    social4_type              = COALESCE($98, social4_type),
    social5_uuid              = COALESCE($99, social5_uuid),
    social5_url               = COALESCE($100, social5_url),
    social5_type              = COALESCE($101, social5_type),
    social6_uuid              = COALESCE($102, social6_uuid),
    social6_url               = COALESCE($103, social6_url),
    social6_type              = COALESCE($104, social6_type),
    social7_uuid              = COALESCE($105, social7_uuid),
    social7_url               = COALESCE($106, social7_url),
    social7_type              = COALESCE($107, social7_type),
    social8_uuid              = COALESCE($108, social8_uuid),
    social8_url               = COALESCE($109, social8_url),
    social8_type              = COALESCE($110, social8_type),
    social9_uuid              = COALESCE($111, social9_uuid),
    social9_url               = COALESCE($112, social9_url),
    social9_type              = COALESCE($113, social9_type),
    tracking_source           = COALESCE($114, tracking_source),
    tracking_slug             = COALESCE($115, tracking_slug),
    cached_img                = COALESCE($116, cached_img),
    cached_img_data           = COALESCE($117, cached_img_data),
    crawl                     = COALESCE($118, crawl),
    duplicate_user_id         = COALESCE($119, duplicate_user_id),
    duplicate_alternative_id  = COALESCE($120, duplicate_alternative_id),
    duplicate_report_date     = COALESCE($121, duplicate_report_date),
    entry_date                = COALESCE($122, entry_date),
    edit_date                 = COALESCE($123, edit_date),
    last_kpi_entry_date       = COALESCE($124, last_kpi_entry_date)
WHERE uuid = $125
`
