...
//
// POST /tg
func (h *Handler) TgSessionCreate(ctx context.Context, req *api.TgSessionCreateReq) (api.TgSessionCreateRes, error) {
...
//
// GET /tg
func (h *Handler) TgSessionList(ctx context.Context) (api.TgSessionListRes, error) {
	return nil, ht.ErrNotImplemented
}
...
//
// PUT /tg
func (h *Handler) TgSessionVerify(ctx context.Context, req *api.TgSessionVerifyReq, params api.TgSessionVerifyParams) (api.TgSessionVerifyRes, error) {
	return nil, ht.ErrNotImplemented
}
