...
export function Messages() {
    ...
    return (<FullLayout>
      <Flex direction="row" gap="size-200" margin="size-200" flex>
        ...
        {selected && (<View backgroundColor="gray-100" padding="size-200" width="size-4600" borderStartWidth="thin" borderColor="dark" overflow="auto" UNSAFE_style={{ boxSizing: 'border-box' }}>
            <Flex direction="row" justifyContent="space-between" alignItems="center" marginBottom="size-100">
              ...
              <ActionButton onPress={() => setSelected(null)} aria-label="Close Preview" UNSAFE_style={{ fontSize: '1.2rem' }}>
                ×
              </ActionButton>
            </Flex>
...
//# sourceMappingURL=Messages.jsx.map