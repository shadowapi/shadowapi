...
import { ActionButton, Cell, Column, Divider, Flex, Heading, Row, TableBody, TableHeader, TableView, Text, View, } from '@adobe/react-spectrum';
...
export function WorkerJobs() {
    ...
    const copyToClipboard = (uuid, label) => {
      ...
      <Flex direction="row" gap="size-200" margin="size-200" flex>
        ...
        <View flex={1} minWidth={0}>
              ...
              {(item) => (<Row key={item.uuid}>
                  ...
                  <Cell>
                    <Flex alignItems="center" gap="size-100">
                      ...
                      <ActionButton onPress={() => copyToClipboard(item.scheduler_uuid, 'Scheduler')} aria-label="Copy Scheduler UUID">
                        <Copy size="S"/>
                      </ActionButton>
                    </Flex>
                  </Cell>
          ...
          <Flex marginTop="size-200" gap="size-100">
            {offset > 0 && (<ActionButton onPress={() => setOffset(Math.max(0, offset - limit))} isDisabled={offset === 0}>
                Previous
              </ActionButton>)}
        ...
        {selected && (<View backgroundColor="gray-100" padding="size-200" borderStartWidth="thin" borderColor="dark" overflow="auto" width="460px" flexShrink={0} flexGrow={0} flexBasis="460px" UNSAFE_style={{
...
//# sourceMappingURL=WorkerJobs.jsx.map