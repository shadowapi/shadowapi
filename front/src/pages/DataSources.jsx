...
import { ActionButton, Badge, Cell, Column, Flex, Row, TableBody, TableHeader, TableView, Text, View, } from '@adobe/react-spectrum';
...
export function DataSources() {
    ...
    const mutationRevokeTokens = useMutation({
        ...
        mutationFn: async (datasourceUUID) => {
            ...
            if (listResp.error)
                throw new Error(listResp.error.detail);
    ...
    const handleOauthLogin = async (ds) => {
    ...
    const rows = listQuery.data?.map((ds) => ({
        key: ds.uuid,
        name: ds.name,
        type: ds.type,
...
//# sourceMappingURL=DataSources.jsx.map