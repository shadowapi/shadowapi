...
export function StorageEdit() {
    ...
    useTitle(pageTitle);
    return (<FullLayout>
      <Breadcrumbs marginTop="size-200" marginStart="size-300" onAction={(key) => {
            navigate(key.toString());
        }}>
        <Item key="/storages">Storages</Item>
        <Item key="march 2020 assets">{uuid === 'add' ? 'Add' : 'Edit'} Storage</Item>
      </Breadcrumbs>
      <StorageForm storageUUID={uuid} storageKind={storageKind}/>
    </FullLayout>);
}
//# sourceMappingURL=StorageEdit.jsx.map