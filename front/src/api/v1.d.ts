...
export interface paths {
    ...
    "/auth/oauth2/authorize": {
        ...
        get?: never;
        put?: never;
        /** @description Initiate OAuth2 authorization flow. Returns the authorization URL for redirect. */
        post: operations["auth-oauth2-authorize"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/auth/oauth2/callback": {
        ...
        /** @description OAuth2 callback handler. Exchanges authorization code for tokens and sets cookies. */
        get: operations["auth-oauth2-callback"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/auth/oauth2/refresh": {
        ...
        post: operations["auth-oauth2-refresh"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/auth/oauth2/logout": {
        ...
        get?: never;
        put?: never;
        /** @description Logout the user by revoking tokens and clearing cookies. */
        post: operations["auth-oauth2-logout"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/auth/oauth2/session": {
        ...
        /** @description Check current session status without triggering token refresh. Always returns 200. */
        get: operations["auth-oauth2-session"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        user_session_token: {
            /** @description Session token (deprecated) */
...
export interface operations {
    ...
    "auth-oauth2-callback": {
        ...
        requestBody?: never;
        responses: {
            /** @description Redirect to frontend after successful token exchange */
            302: {
                headers: {
                    /** @description URL to redirect to */
                    Location?: string;
                    /** @description Token cookies (access and refresh) */
                    "Set-Cookie"?: string[];
                    [name: string]: unknown;
                };
                content?: never;
    ...
    "auth-oauth2-refresh": {
        ...
        responses: {
            ...
            200: {
                headers: {
                    /** @description Updated token cookies (access and refresh) */
                    "Set-Cookie"?: string[];
                    [name: string]: unknown;
                };
                content: {
    ...
    "auth-oauth2-logout": {
        ...
        responses: {
            ...
            200: {
                headers: {
                    /** @description Expired cookie headers (clears access and refresh) */
                    "Set-Cookie"?: string[];
                    [name: string]: unknown;
                };
                content: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        ...
                        /** @description Access token expiration time in seconds (only present when authenticated) */
                        expires_in?: number;
                    };
                };
            };
