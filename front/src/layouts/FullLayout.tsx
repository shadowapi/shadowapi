...
export function FullLayout({ children }: { children: ReactNode }) {
  ...
  const navItems = [
    { Label: "Dashborad", AriaLabel: "Go to dashboard page", Icon: <Homepage />, URL: "/" },
    ...
    { Label: "OAuth2 Credentials", AriaLabel: "Go to OAuth2 credentials page", Icon: <Login />, URL: "/oauth2/credentials" },
    ...
    <Flex direction="column" height="100vh">
      <View height="size-800" colorVersion={6} backgroundColor="gray-200">
        <Flex justifyContent="space-between" height="100%">
          <Heading level={2} justifySelf="start" marginX="size-600">ShadowAPI</Heading>
      ...
      <Flex direction={{ base: 'column', M: 'row' }} flex>
        ...
        <Flex direction="column" flexGrow={1} minWidth={0} minHeight={0}>{children}</Flex>
      </Flex>
    </Flex>
  )
}
