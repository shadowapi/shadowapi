 ...
 */
import type { MessageBodyParsedProperty } from './messageBodyParsedProperty';
import type { MessageReactions } from './messageReactions';
import type { MessageAttachmentsItem } from './messageAttachmentsItem';
import type { MessageForwardMeta } from './messageForwardMeta';
import type { MessageMetaProperty } from './messageMetaProperty';
...
export interface Message {
  ...
  body: string;
  body_parsed?: MessageBodyParsedProperty;
  ...
  forward_meta?: MessageForwardMeta;
  meta?: MessageMetaProperty;
